...
type="text/css" media="screen" />
 ...
 <body>
	...
	<p class="Explications"> 
		...
		<p class="Explications"> Une fois votre historique importé, notre application va analyser vos parties afin de déterminer des statistiques afin que vous puissiez progresser.</p>
		<p class="Explications"> Les statistiques analysées en arêne côtée sont : votre pourcentage de victoire, votre total de points de côte sur les X dernières parties, les classes contre et avec lesquelles vous gagnez et perdez le plus.
		Ces statistiques peuvent être triée en fonction de votre spécialization et en 2v2, 3v3 ou pour les deux modes. 
	</p>
